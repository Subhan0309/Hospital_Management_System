...
RSpec.describe MedicalRecord, type: :model do
  ...
  context 'associations' do
   ...
   # Create comments associated with the existing medical record
      comment1 = create(:comment, associated_with: medical_record, created_by: doctor)
      comment2 = create(:comment, associated_with: medical_record, created_by: patient)   
